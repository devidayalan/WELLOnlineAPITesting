...
public class DeleteDocumentByDocumentId extends TestBase {
	
	
	@Test
	public void deleteDocumentBydocumentId() throws IOException {
		...
		res =
				...
				.when()
						.delete("project-document/{project_id}/{doc_id}")
