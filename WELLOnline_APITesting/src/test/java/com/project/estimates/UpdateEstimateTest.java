...
public class UpdateEstimateTest extends TestBase {
	@Test
	@SuppressWarnings("unchecked")
	public void updateEstimatebyEstimateId() throws IOException {
			...
			projObj.put("id", ExcelParserUtils.getSingleCellData(loginUserfile_path, estimateSheet, "Projects Id", 2));
		...
		res =
				...
				.when()
						.put("estimate/update/{estimate_id}")
				.then()
						
						.log().body()
						.statusCode(STATUS_200)
						.body("id", Matchers.equalTo(estimateId) )
						.extract().response();
