...
public class GetConceptPhaseSummaryTests extends TestBase {
	
	@Test
	public void getConceptPhaseSummaryByScorecardId() throws IOException {
		...
		res =
				...
				.when()
						.get("scorecard/conceptPhaseSummary/{scorecard_id}/{concept_id}")
				.then()
