...
public class GetPortfolioSubsetByIdTests extends TestBase {
	
	@Test
	public void getPortfolioSubsetById() throws IOException {
		...
		res =
				...
				.when()
						.get("portfolio/{portfolio_id}/subset/{subset_id}")
				.then()
