...
//import com.common.base.HelperMethods;

import io.restassured.path.json.JsonPath;
import io.restassured.path.xml.XmlPath;
import io.restassured.response.Response;

public class TestUtils {private static Logger log = Logger.getLogger(TestUtils.class.getName());
...
//	HelperMethods.testlog("Info","**Verifying Response Code**");
	int statusCode = response.getStatusCode();
	log.info(statusCode);
//	HelperMethods.testlog("Pass","**Verified Response Code Successfully**" +statusCode);
	return statusCode;
}
